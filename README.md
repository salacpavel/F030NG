...
- ~~Incorporates much, **much faster DSP with four times more on-board memory**~~ Due to incompatibilities of MC56301 DSP the embededed form of the DSP processor has been omitted in favour of expansion slot. This enables use of plug-in boards in different configurations and forms, such as advanced digital sound cards, data processors, oscilloscopes, etc.
