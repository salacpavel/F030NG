...
- ~~Removes legacy cartridge interface due to general unavailability of replacement edge board connectors~~ as I have found suitbale replacement, cartridge port in some form will re-appear on R02 board
